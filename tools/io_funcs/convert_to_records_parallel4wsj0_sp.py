...
def process_in_each_thread(line, name, apply_cmvn, cmvn_for_labels):
    ...
    with tf.python_io.TFRecordWriter(tfrecords_name) as writer:
        ...
        ex = make_sequence_example_two_labels(inputs, labels1,labels2)
...
def main(unused_argv):
    ...
    convert_to(FLAGS.mode, apply_cmvn=FLAGS.apply_cmvn,cmvn_for_labels=cmvn_for_labels)
